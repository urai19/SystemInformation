...
var identify_1 = require("@amplitude/identify");
var types_1 = require("@amplitude/types");
var utils_1 = require("@amplitude/utils");
var defaultRetry_1 = require("./retry/defaultRetry");
var constants_1 = require("./constants");
var middlewareRunner_1 = require("./middleware/middlewareRunner");
var NodeClient = /** @class */ (function () {
    ...
    function NodeClient(apiKey, options) {
        ...
        this._apiKey = apiKey;
        this._options = Object.assign({}, constants_1.DEFAULT_OPTIONS, options);
        this._setUpLogging();
        this._transportWithRetry = (_a = this._options.retryClass) !== null && _a !== void 0 ? _a : this._setupDefaultTransport();
        this._middlewareRunner = new middlewareRunner_1.MiddlewareRunner();
        if (!utils_1.isNodeEnv()) {
            utils_1.logger.warn('@amplitude/node initialized in a non-node environment and will not work. If you are planning to add Amplitude to a browser environment, please use amplitude-js');
        }
    }
    /**
     * @inheritDoc
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this._events.length === 0) {
                            return [2 /*return*/, types_1.SKIPPED_RESPONSE];
                        }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.resolve(types_1.SKIPPED_RESPONSE)];
                    ...
                    case 2:
                        ...
                        utils_1.logger.warn('Middleware chain skipped logEvent action.');
                        return [4 /*yield*/, Promise.resolve(types_1.SKIPPED_RESPONSE)];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4:
                        if (!!utils_1.isValidEvent(event)) return [3 /*break*/, 6];
                        utils_1.logger.warn('Found invalid event - skipping logEvent action.');
                        return [4 /*yield*/, Promise.resolve(types_1.SKIPPED_RESPONSE)];
    ...
    NodeClient.prototype.identify = function (userId, deviceId, identify) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!(identify instanceof identify_1.Identify)) return [3 /*break*/, 2];
                        utils_1.logger.warn('Invalid Identify object. Skipping operation.');
                        return [4 /*yield*/, Promise.resolve(types_1.SKIPPED_RESPONSE)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
    ...
    NodeClient.prototype._observeEvent = function (event) {
        if (typeof this._options.plan !== 'undefined') {
            event.plan = tslib_1.__assign(tslib_1.__assign({}, this._options.plan), event.plan);
        }
    };
    NodeClient.prototype._setupDefaultTransport = function () {
        return new defaultRetry_1.RetryHandler(this._apiKey, this._options);
    };
    NodeClient.prototype._setUpLogging = function () {
        if (this._options.debug || this._options.logLevel > 0) {
            if (this._options.logLevel > 0) {
                utils_1.logger.enable(this._options.logLevel);
            }
            else {
